...
class Consultation:
    def __init__(self, date_heure: datetime, patient: Patient, nom_medecin: str, motif: str, statut: str = "planifiée"):
        ...
        #Verification statut IMPORTANT pour la suite (Lenny quand tu changeras le statut)
    ...
    #Méthode : changer de date la consultation si c'est pas déjà passé / annulée
    ...
    #Méthode : ajouter un diagnostic à la consultation si elle a eu lieu
    ...
    #Méthode : ajouter une prescription à la consultation si elle a eu lieu
    ...
    #Méthode : marquer la consultation comme réalisée
